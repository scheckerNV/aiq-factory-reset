...
class BCMToolConfig(FunctionBaseConfig, name="bcm_tool"):
...
@register_function(config_type=BCMToolConfig, framework_wrappers=[LLMFrameworkEnum.LANGCHAIN])
async def bcm_tool(config: BCMToolConfig, builder: Builder):
    """
    ...
    async def _search_bcm_docs(query: str) -> str:
        ...
        try:
            ...
            logger.info("Executing BCM query: %s", query)
    ...
    yield FunctionInfo.from_fn(
        _search_bcm_docs,
        description=
        "Generate BCM (Bright Cluster Manager) commands based on networking requirements and cluster configuration")


print("✅ BCM tool registered successfully")
